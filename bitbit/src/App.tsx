      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 px-4 py-2 z-50">
        <div className="max-w-lg mx-auto">
          <div className="flex justify-around items-center">
            ...
            >
              <div className="flex flex-col items-center">
                <Icon name="users" size="lg" className="mb-1" />
        ...
        {devConfig.showDebugComponents && (
          <div className="fixed bottom-20 right-4 z-50 flex flex-col gap-2">
            ...
            <NavLink
              to="/test/chat-navigation"
              className="bg-teal-500 text-white px-3 py-1 rounded text-xs hover:bg-teal-600 transition-colors"
            >
              聊天导航测试
            </NavLink>
          </div>
