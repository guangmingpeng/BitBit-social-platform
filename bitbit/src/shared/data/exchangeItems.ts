...
export const exchangeItemsData: Record<string, ExchangeItemData> = {
  ...
  "exchange-1": {
    ...
    description:
      "专业级全画幅无反相机，使用时间不长，成色很好。包含原装充电器、数据线、说明书等全套配件。适合摄影爱好者或专业摄影师使用。",
    condition: "九成新",
    category: "数码产品",
    price: 15800,
    originalPrice: 20000,
    ...
    images: [
      "https://picsum.photos/400/400?random=camera1",
      "https://picsum.photos/400/400?random=camera2",
      "https://picsum.photos/400/400?random=camera3",
    ],
    status: "available",
    seller: {
      name: "子龙",
    ...
    specifications: [
      ...
      { label: "型号", value: "EOS R5" },
      { label: "像素", value: "4500万" },
      { label: "镜头卡口", value: "RF卡口" },
      { label: "购买时间", value: "2023年5月" },
    ],
    exchangePreferences: ["镜头", "摄影器材", "现金交易"],
  },
  "exchange-2": {
    id: "exchange-2",
    title: "全新未拆封 iPad Pro 12.9寸",
    description:
      "全新未拆封的iPad Pro，WiFi版本，M2芯片，512GB存储。原价购买后一直没有使用，现在想换其他设备。包装完整，提供购买凭证。",
    condition: "全新",
    category: "数码产品",
    price: 6500,
    originalPrice: 8000,
    ...
    images: [
      "https://picsum.photos/400/400?random=ipad1",
      "https://picsum.photos/400/400?random=ipad2",
      "https://picsum.photos/400/400?random=ipad3",
    ],
    status: "hot",
    seller: {
      name: "子龙",
    ...
    specifications: [
      { label: "品牌", value: "Apple" },
      { label: "型号", value: "iPad Pro 12.9寸" },
      { label: "处理器", value: "M2芯片" },
      { label: "存储", value: "512GB" },
      { label: "购买时间", value: "2024年1月" },
    ],
    exchangePreferences: ["MacBook", "iPhone", "现金交易"],
  },
};
